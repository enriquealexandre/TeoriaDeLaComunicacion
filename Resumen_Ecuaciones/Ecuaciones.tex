...
\begin{center}
    ...
    \begin{tabular}{|c|c|c|c|}
        \multicolumn{4}{c}{{\bf Modulaciones lineales }} \\
        \hline
        & {\bf Modulación AM } & {\bf Modulación DBL} & {\bf Modulación FM} \\
        \hline
        Señal & $A_p \cdot [1 + m x_n(t)] \cdot \cos(\omega_p t)$ & $A_p \cdot x(t) \cdot \cos(\omega_p t)$ & $A_p \cdot \cos \left ( \omega_p t + \omega_d \int^t x(\lambda) d\lambda \right )$\\
        \hline
        Potencia media & $\displaystyle\frac{A_p^2}{2} + \displaystyle\frac{m^2 A_p^2}{2} S_{xn} = P_p + 2P_{BL}$ & $\displaystyle\frac{A_p^2}{2}S_x = 2 P_{BL}$ & $\frac{A_p^2}{2}$ \\
        \hline
        Potencia de cresta & $\displaystyle\frac{1}{2} A_p^2 (1+m)^2$ & $\displaystyle\frac{1}{2} [A_p \cdot |x(t)|_{max}]^2$ & $\frac{A_p^2}{2}$\\
        \hline
        \multirow{3}{*}{Ancho de banda} & \multicolumn{2}{c|}{$B_T = 2 \cdot W_x$} & $B_T \approx 2 (D+a) W_x$\\
    ...
    \renewcommand{\arraystretch}{1.5}
    \begin{tabular}{|c|c|}
        \multicolumn{2}{c}{{\bf Ruido en modulaciones analógicas }} \\
        \hline
        SNR en banda base & $\gamma = \displaystyle\frac{S_x}{N_0 W_x}$ \\
        \hline
        SNR en predetección &  $\left ( \displaystyle\frac{S}{N} \right )_R = \displaystyle\frac{W_x}{B_T} \cdot \gamma $\\
        \hline
        Modulación AM & $\left ( \displaystyle\frac{S}{N} \right )_D = \displaystyle\frac{m^2 S_{xn}}{1 + m^2 S_{xn}} \cdot \gamma $ \\
        \hline 
        Modulación DBL & $\left ( \displaystyle\frac{S}{N} \right )_D = \gamma $ \\
        \hline
        Modulación FM & $\left ( \displaystyle\frac{S}{N} \right )_D = 3D^2 S_{xn}\gamma$ \\    
        \hline
        Modulación FM deénfasis ($B_{de} \ll W_x$) & $\left ( \displaystyle\frac{S}{N} \right )_D = \displaystyle\frac{\omega_d^2}{B_{de}^2} S_x \gamma$ \\
        \hline
    \end{tabular}      
    \renewcommand{\arraystretch}{1}
    \vspace{0.5cm}
    ...
    \renewcommand{\arraystretch}{2.2}
        \begin{tabular}{|c|c|c|}
            \multicolumn{3}{c}{{\bf Modulaciones digitales}}\\
            \hline
            \multicolumn{2}{|c|}{Sistema M-ario unidimensional} & $P_e = \displaystyle\frac{2(M-1)}{M} Q \left ( \displaystyle\frac{d}{\sqrt{2 N_0}} \right ) $\\[1ex]
            \hline
            \multicolumn{2}{|c|}{Cota de la unión} & $P_e \leq \displaystyle\frac{1}{M} \displaystyle\sum\limits_{i=1}^{M} \displaystyle\sum\limits_{\substack{k=1 \\ k\neq i}}^{M} Q \left ( \displaystyle\frac{d_{ik}}{\sqrt{2 N_0}} \right )$ \\ [1ex]
            \hline
            \multicolumn{2}{|c|}{Cota de la unión simplificada} & $P_e \leq (M-1) \cdot Q \left ( \displaystyle\frac{d_{min}}{\sqrt{2 N_0}} \right )$ \\[1ex]
            \hline
            ...
            \hline
            \multirow{2}{*}{FSK coherente} & $M=2$ & $P_e = Q\left ( \sqrt{\displaystyle\frac{E_b}{N_0}} \right)$ \\
            \cline{2-3}
            & $M\geq 4$ & $P_e = (M-1) \cdot Q\left ( \sqrt{\displaystyle\frac{E_s}{N_0}} \right)$ \\
            \hline
            FSK no coherente & $M=2$ & $P_e = \displaystyle\frac{1}{2} e^{-\displaystyle\frac{E_b}{2 N_0}}$ \\
            \hline
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
        ...
        \begin{tabular}{|c|c|c|}
            ...
            \hline
             & $ h(t) = \left \{ \begin{array}{lc} \displaystyle\frac{1}{\sqrt{T}} & 0\leq t < T \\ 0 & \text{c.c.} \end{array}\right. $ & $ h(t) = \displaystyle\frac{\sen\left ( \displaystyle\frac{\pi}{T} t \right ) }{\displaystyle\frac{\pi}{T}t}$ \\
            \hline
            ...
            \hline
            M-FSK (coherente) & $\displaystyle\frac{(M+3) R_b}{2 \cdot log_2(M)} = \displaystyle\frac{(M+3)}{2\cdot T}$ & $\displaystyle\frac{(M+1) R_b}{2 \cdot log_2(M)} = \displaystyle\frac{(M+1)}{2\cdot T}$ \\[1ex]
            \hline
            M-FSK (no coherente) & $\displaystyle\frac{(M+1) R_b}{log_2(M)} = \displaystyle\frac{(M+1)}{T}$ & $\displaystyle\frac{M \cdot R_b}{log_2(M)} = \displaystyle\frac{M}{T}$ \\[1ex]
            \hline
