...
\begin{center}
   ...
   {\bf GENERAL EQUATIONS}
    ...
    \renewcommand{\arraystretch}{2}
        \begin{tabular}{|c|c|}
            \multicolumn{2}{c}{{\bf Densidad espectral de potencia de la PAM (banda base)}}\\
            \hline
            $x(t) = \displaystyle\sum\limits_{n=-\infty}^{\infty} a_n h(t-nT)$ &
            $S_x(\omega) = \displaystyle\frac{1}{T} |H(\omega)|^2 S_a(\omega)$\\
            \hline
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
        ...
        \begin{tabular}{|c|c|c|}
            ...
            \hline
            coherent M-FSK & $\displaystyle\frac{(M+3) R_b}{2 \cdot log_2(M)} = \displaystyle\frac{(M+3)}{2\cdot T}$ & $\displaystyle\frac{(M+1) R_b}{2 \cdot log_2(M)} = \displaystyle\frac{(M+1)}{2\cdot T}$ \\[1ex]
            \hline
            non-coherent M-FSK & $\displaystyle\frac{(M+1) R_b}{log_2(M)} = \displaystyle\frac{(M+1)}{T}$ & $\displaystyle\frac{M \cdot R_b}{log_2(M)} = \displaystyle\frac{M}{T}$ \\[1ex]
            \hline
