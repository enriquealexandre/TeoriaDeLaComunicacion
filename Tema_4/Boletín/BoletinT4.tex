...
\Problema {
	...
	\begin{subfigure}{}
	\includegraphics[width=4cm]{./Figuras/Problema4_1a}
	\end{subfigure}
	\begin{subfigure}{}
	\includegraphics[width=4cm]{./Figuras/Problema4_1b}
	\end{subfigure} \\
	\begin{subfigure}{}
	\includegraphics[width=4cm]{./Figuras/Problema4_1c}
	\end{subfigure}
	\begin{subfigure}{}
	\includegraphics[width=4cm]{./Figuras/Problema4_1d}
	\end{subfigure}
	\end{figure*}}
...
\end{enumerate}
	...
	{\begin{figure*}[h!]\centering\includegraphics[width=10cm]{./Figuras/Problema4_1_sol}\end{figure*}}
}		
{
...
\begin{enumerate}
	...
	\item \
	{\begin{figure*}[h!]\centering\includegraphics[width=6cm]{./Figuras/Problema4_5_sol}\end{figure*}}
\end{enumerate}
}
{
...
donde $i=1,2,3,4$ y $\omega_c  = n_c\cdot \frac{w\pi}{T}$ para algún valor entero $n_c$.
...
where $i=1,2,3,4$ and $\omega_c  = n_c\cdot \frac{w\pi}{T}$ for some integer value $n_c$.
...
\begin{enumerate}
	...
	\begin{figure*}[h!] 	\centering\includegraphics[width=3.5cm]{./Figuras/Problema4_11_sol} 	\end{figure*}
